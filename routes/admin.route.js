...
const { adminRegisterHandler, adminSignInHandler, giveInstructorAccess, getUsersData, deleteUser, getInstructorData, deactivateInstructor, deactivateUser, deleteInstructor } = require("../controller/admin.controller");
